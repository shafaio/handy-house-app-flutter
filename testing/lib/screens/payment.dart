...
// import 'package:testing/screens/galerry.dart';
import 'package:testing/screens/notification.dart';
// import 'package:testing/screens/homes.dart';
                                    ...
                                    showDialog(
                                        ...
                                        builder: (context) {
                                          return Container(
                                            child: AlertDialog(
                                                title: Text(
                                                    'Your transaction is accepted by this method'),
                                                actions: [
                                                  TextButton(
                                                    onPressed: () {
                                                      Navigator.push(
                      ...
                      onPressed: () {
                        showDialog(
                            ...
                            builder: (context) => AlertDialog(
                                  ...
                                  content: const Text(
                                      'Do you want see transaction detail?'),
                                  actions: [
                                    ElevatedButton(
